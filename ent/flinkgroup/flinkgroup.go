...
const (
	// Label holds the string label denoting the flinkgroup type in the database.
	Label = "flink_group"
	...
	EdgeLinks = "links"
	// Table holds the table name of the flinkgroup in the database.
	Table = "flink_groups"
	// LinksTable is the table that holds the links relation/edge.
	LinksTable = "flinks"
	// LinksInverseTable is the table name for the FLink entity.
	// It exists in this package in order to avoid circular dependency with the "flink" package.
	LinksInverseTable = "flinks"
	// LinksColumn is the table column denoting the links relation/edge.
	LinksColumn = "group_id"
)

// Columns holds all SQL columns for flinkgroup fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the FLinkGroup queries.
