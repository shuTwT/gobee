...
func (_q *Oauth2CodeQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *Oauth2CodeQuery) FirstIDX(ctx context.Context) int {
...
func (_q *Oauth2CodeQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *Oauth2CodeQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *Oauth2CodeQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *Oauth2CodeQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *Oauth2CodeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(oauth2code.Table, oauth2code.Columns, sqlgraph.NewFieldSpec(oauth2code.FieldID, field.TypeInt))
	_spec.From = _q.sql
