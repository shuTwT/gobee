...
func (_c *PayChannelCreate) SetName(v string) *PayChannelCreate {
...
func (_c *PayChannelCreate) SetType(v string) *PayChannelCreate {
	_c.mutation.SetType(v)
	return _c
}

// SetConfig sets the "config" field.
func (_c *PayChannelCreate) SetConfig(v string) *PayChannelCreate {
	_c.mutation.SetConfig(v)
	return _c
}

// SetID sets the "id" field.
func (_c *PayChannelCreate) SetID(v uuid.UUID) *PayChannelCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *PayChannelCreate) SetNillableID(v *uuid.UUID) *PayChannelCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *PayChannelCreate) check() error {
	...
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "PayChannel.name"`)}
	}
	...
	if _, ok := _c.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`ent: missing required field "PayChannel.type"`)}
	}
...
func (_c *PayChannelCreate) createSpec() (*PayChannel, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(paychannel.Table, sqlgraph.NewFieldSpec(paychannel.FieldID, field.TypeUUID))
	)
