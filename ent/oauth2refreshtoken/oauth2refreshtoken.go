...
const (
	// Label holds the string label denoting the oauth2refreshtoken type in the database.
	Label = "oauth2refresh_token"
	...
	// Table holds the table name of the oauth2refreshtoken in the database.
	Table = "oauth2refresh_tokens"
)

// Columns holds all SQL columns for oauth2refreshtoken fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the Oauth2RefreshToken queries.
