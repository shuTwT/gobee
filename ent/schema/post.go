...
func (Post) Fields() []ent.Field {
	return []ent.Field{
		...
		field.String("alias").NotEmpty().Optional().Nillable().MaxLen(255).Comment("文章别名"),
		...
		field.Bool("is_pin_to_top").Default(false).Comment("是否置顶"),
		...
		field.Int("price").Default(0).NonNegative().Comment("文章价格"),
