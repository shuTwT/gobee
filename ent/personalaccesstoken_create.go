...
func (_c *PersonalAccessTokenCreate) SetExpires(v time.Time) *PersonalAccessTokenCreate {
	_c.mutation.SetExpires(v)
	return _c
}

// SetNillableExpires sets the "expires" field if the given value is not nil.
func (_c *PersonalAccessTokenCreate) SetNillableExpires(v *time.Time) *PersonalAccessTokenCreate {
	if v != nil {
		_c.SetExpires(*v)
	}
	return _c
...
func (_c *PersonalAccessTokenCreate) SetID(v int) *PersonalAccessTokenCreate {
	_c.mutation.SetID(v)
	return _c
}
