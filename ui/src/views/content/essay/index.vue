...
<template>
    ...
    <div class="max-w-[1600px] mx-auto">
      ...
      <div class="essay-header">
        ...
        <div class="header-right">
          <n-button type="primary" @click="handleCreate" round size="large">
            <template #icon>
              <svg
                width="18"
                height="18"
        ...
        <n-spin :show="loading" size="large">
          ...
          >
            ...
            <div class="card-header">
              <div class="user-info">
                <n-avatar size="large" class="user-avatar" />
              ...
              <!-- 状态标签 -->
              <n-tag :type="item.draft ? 'warning' : 'success'" round size="small">
                {{ item.draft ? '草稿' : '已发布' }}
              </n-tag>
            </div>
  ...
  >
    <n-form :model="formData" label-placement="left" label-width="80px" class="essay-form">
      ...
      <n-form-item label="状态" class="status-item">
        <div class="status-switch">
          ...
          <n-switch v-model:value="formData.draft" size="large" class="status-toggle" />
        </div>
      </n-form-item>
    </n-form>
