...
const currentTagId = ref<number | undefined>(undefined)
...
const columns: DataTableColumns<any> = [
  ...
  },
  {
    ...
    width: 120,
    render: (row) => {
      return h('span', { style: { display: 'inline-block', width: '20px', height: '20px', backgroundColor: row.color || '#ccc', borderRadius: '4px' } })
    },
  },
  {
    title: '描述',
...
<template>
  <div class="container-fluid p-6">
    <n-card title="标签管理" class="tag-card">
